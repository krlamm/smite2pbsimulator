...
const LandingPage = () => {
  ...
  return (
    <div className="bg-[#121a23] min-h-screen text-white font-sans">
      <div className="container mx-auto px-4 py-8 relative">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-yellow-400 tracking-wider">SMITE 2 PICK/BAN SIMULATOR</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-[#1a2430] p-6 rounded-lg border border-gray-700">
            ...
            <p className="text-gray-400 mb-6">Practice draft strategies on your own. Control both teams and experiment with different picks and bans.</p>
            <button
          ...
          <div className="bg-[#1a2430] p-6 rounded-lg border border-gray-700">
            ...
            <p className="text-gray-400 mb-6">Create a draft lobby and invite friends to join. Perfect for team practice or competitive preparation.</p>
            <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div>
            <h2 className="text-3xl font-bold text-yellow-400 mb-4">Join a Friend's Draft</h2>
            <div className="bg-[#1a2430] p-6 rounded-lg border border-gray-700">
              <FriendDraftsList />
            </div>
          </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-3xl font-bold text-yellow-400">Friends List</h2>
              <button className="text-gray-400 hover:text-white flex items-center">
